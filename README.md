...
そう、自分も最初そう思ってた。でも字幕と副音声が出ないんよ。日本独自の放送の仕様に合わせてプレイヤーをカスタマイズする必要があるんよ。

### TIFとかよくわからんし、普通にクライアントアプリにすればよくない？
いやほら、なんか、メーカー組み込みのテレビアプリに統合できるのってロマンあるじゃん？フロントエンドを開発する手間も減るし。
